...
import uz.xia.bazar.data.nomination.Address
import uz.xia.bazar.ui.profile.addresses.add.model.NominationResponse
import uz.xia.bazar.ui.profile.addresses.add.model.Place
...
interface NominationService {
    ...
    companion object {
        ...
        fun getInstance(): NominationService {
            ...
            if (INSTANCE == null) {
                val retrofit = Retrofit.Builder().baseUrl(NOMINATION_URL)
                    .client(httpClient)
