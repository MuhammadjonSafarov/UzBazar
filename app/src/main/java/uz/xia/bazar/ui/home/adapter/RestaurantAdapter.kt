...
class RestaurantAdapter : ListAdapter<Restaurant, RestaurantAdapter.RestaurantVH>(ItemDiffer) {

    class RestaurantVH(binding: ItemLayoutRestaurantBinding) : RecyclerView.ViewHolder(binding.root) {
